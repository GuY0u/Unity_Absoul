...
public class SceneLoader : MonoBehaviour
{
    ...
    {
        //호출할 씬의 정보를 딕셔너리에 추가
        loadScenes.Add("ManagementScenes_Level1", LoadSceneMode.Additive);
        loadScenes.Add("ManagementScenes_Play", LoadSceneMode.Additive);
    }
    ...
    IEnumerator Fade(float finalAlpha)
    {
        ...
        SceneManager.SetActiveScene(SceneManager.GetSceneByName("ManagementScenes_Level1"));
